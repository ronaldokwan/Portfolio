      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hello there, I'm <span className="purple">Ronaldo Kwan</span>, a
            ...
            Program at Hacktiv8 Coding Bootcamp, and I'm thrilled to embark on
            this exciting journey in the{" "}
            <span className="purple">tech industry</span>.
          </p>
          <p style={{ textAlign: "justify" }}>
            While coding is my true calling, I believe in nurturing a{" "}
            <span className="purple">well-rounded lifestyle</span>. When I'm not
            immersed in code, you'll find me:
          </p>
